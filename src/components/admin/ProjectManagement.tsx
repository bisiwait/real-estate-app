                    ...
                    {loading && projects.length === 0 ? (
                        ...
                        paginatedProjects.map((project) => {
                            ...
                            const developerName = (project as any).developer_id
                                ...
                                : null
                            return (
                                <div key={project.id} className="hover:bg-slate-50/30 transition-colors">
                                    {/* Mobile layout */}
                                    <div className="md:hidden">
                                        ...
                                        <div className="flex items-stretch gap-0">
                                            ...
                                            <div className="w-24 h-24 flex-shrink-0 overflow-hidden bg-slate-100">
                                                {project.image_url ? (
                                                    ...
                                                    <div className="w-full h-full flex items-center justify-center bg-navy-primary/5">
                                                        <Building2 className="w-8 h-8 text-navy-primary/20" />
                                                    </div>
                                                )}
                                            </div>
                                            {/* Title block */}
                                            <div className="flex-1 px-3 py-2.5 flex flex-col justify-between">
                                                <div>
                                                    <div className="flex items-start justify-between gap-2">
                                                        <div className="flex-1">
                                                            <p className="text-sm font-black text-navy-secondary leading-snug">{project.name}</p>
                                                            {project.name_jp && (
                                                                <p className="text-[10px] font-bold text-slate-400 mt-0.5">{project.name_jp}</p>
                                                            )}
                                                        </div>
                                                        {/* Actions */}
                                                ...
                                                {/* Type badge */}
                                                <span className="inline-flex items-center text-[9px] font-black text-navy-primary bg-navy-primary/8 px-1.5 py-0.5 rounded-md w-fit mt-1">
                                                    <Layers className="w-2.5 h-2.5 mr-0.5" />{project.property_type}
                                                </span>
                                            </div>
                                        </div>
                                        {/* Info grid */}
                                        <div className="px-3 py-2.5 grid grid-cols-2 gap-x-4 gap-y-2 border-t border-slate-100 bg-slate-50/50">
