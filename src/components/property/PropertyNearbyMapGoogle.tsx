...
type PropertyNearbyMapGoogleProps = PropertyNearbyMapViewProps & {
    onFailure: () => void
}
...
export default function PropertyNearbyMapGoogle({
    center,
    nearby,
    locale,
    currentLabel,
    ...
    useEffect(() => {
        ...
        const run = async () => {
            try {
                ...
                console.warn('[PropertyNearbyMapGoogle] init failed, falling back to Leaflet', error)
