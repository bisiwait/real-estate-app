...
export default async function DashboardPage({
    ...
    searchParams: { tab?: string; profile_updated?: string }
}) {
    const { tab = 'properties', profile_updated } = await searchParams
            ...
            <div className="container mx-auto px-4 -mt-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        {/* Credits Card */}
                        <CreditSection initialCredits={profile?.available_credits || 0} />
                            ...
                            {tab === 'properties' ? (
                                <>
                                    <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                                        ...
                                        <span className="text-xs font-bold text-slate-400">Total: {stats.total} items</span>
                                    </div>
